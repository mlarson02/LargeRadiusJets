...
def plot_heatmap(objectType, data, eta_bins, phi_bins, title, filename, gFexDataForTopos=[], jFexDataForTopos=[], log=False, 
            ...
            if objectType == "jfex_smallR":
                if Et >= 20:
                    ...
                    rect = patches.Rectangle((eta - 0.35, phi - 0.35), 0.7, 0.7,
                                 edgecolor='black', facecolor='none', lw=1)
                    plt.gca().add_patch(rect)
                max_jfex_srjs.append((Et, eta, phi))
            

            if objectType == "topo422" or objectType == "caloTopoTowers":
                gFexEt = gFexDataForTopos[i][j]
                jFexEt = jFexDataForTopos[i][j]
                max_jfex_srjs.append((jFexEt, eta, phi))
    ...
    if objectType == "topo422" or objectType == "caloTopoTowers" and len(max_jfex_srjs) > 0:
        ...
        for _, eta, phi in max_jfex_srjs[:2]: 
            ...
            with open(output_file_jfex, "w") as f_jfex:
                ...
                for fileName in fileNames:
                    ...
                    for entry in range(t.GetEntries()):
                        ...
                        topo_422_highest128_heatmap = np.zeros((len(eta_bins) - 1, len(phi_bins) - 1))
                        caloTopoTowers_heatmap = np.zeros((len(eta_bins) - 1, len(phi_bins) - 1))
                        ...
                        caloTopoTowers_log_heatmap = np.zeros((len(eta_bins) - 1, len(phi_bins) - 1))
                        ...
                        if signalBool:
                            if higgs_average_pt > higgs_min_average_pt and higgsPlotCounter < 50:
                                higgsPlotCounter += 1
                                empty = []
                                #plot_heatmap(topo_heatmap, eta_bins, phi_bins, 'TopoClusters: $E_T$ in Eta-Phi Plane', plotsDir + f'/topo_heatmap_event{eventCounter}.pdf', False, higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                plot_heatmap("caloTopoTowers", caloTopoTowers_heatmap, eta_bins, phi_bins, 'caloTopoTowers: $E_T$ in Eta-Phi Plane', plotsDir + f'/caloTopoTowers_event{eventCounter}.pdf', gfex_heatmap, jfex_heatmap, False, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi, higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                plot_heatmap("topo422", topo_422_heatmap, eta_bins, phi_bins, 'Topo422Clusters: $E_T$ in Eta-Phi Plane', plotsDir + f'/topo_422_heatmap_event{eventCounter}.pdf', gfex_heatmap, jfex_heatmap, False, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi, higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                plot_heatmap("topo422", topo_422_highest128_heatmap, eta_bins, phi_bins, 'Topo422Clusters: $E_T$ in Eta-Phi Plane', plotsDir + f'/topo_422_highest128_heatmap_event{eventCounter}.pdf', gfex_heatmap, jfex_heatmap, False, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi, higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                plot_heatmap("gfex_smallr", gfex_heatmap, eta_bins, phi_bins, 'gFex SmallR Jets: $E_T$ in Eta-Phi Plane', plotsDir + f'/gfex_heatmap_event{eventCounter}.pdf', empty, empty, False, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi,  higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                if jFexPlotsBool:
                                    plot_heatmap("jfex_smallR", jfex_heatmap, eta_bins, phi_bins, 'jFex: $E_T$ in Eta-Phi Plane', plotsDir + f'/jfex_heatmap_event{eventCounter}.pdf', empty, empty, False, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi,  higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                plot_heatmap("truthjet", truthInTimeJets_heatmap, eta_bins, phi_bins, 'InTimeAntiKt4TruthJets: $E_T$ in Eta-Phi Plane', plotsDir + f'/truth_jets_heatmap_event{eventCounter}.pdf', empty, empty, False, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi,  higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                plot_heatmap("hltjet", hltJets_heatmap, eta_bins, phi_bins, 'HLT_AntiKt4EMTopoJets_subjesIS: $E_T$ in Eta-Phi Plane', plotsDir + f'/hlt_jets_heatmap_event{eventCounter}.pdf', empty, empty, False, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi,  higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                plot_heatmap("gfex_larger", gfex_largerJets_heatmap, eta_bins, phi_bins, 'L1_gFexLRJetRoI: $E_T$ in Eta-Phi Plane', plotsDir + f'/gfex_larger_jets_heatmap_event{eventCounter}.pdf', empty, empty, False, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi,  higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)

                                #plot_heatmap(topo_log_heatmap, eta_bins, phi_bins, 'TopoClusters: $Log(E_T)$ in Eta-Phi Plane', plotsDir + f'/topo_log_heatmap_event{eventCounter}.pdf', True, higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                plot_heatmap("topo422", topo_422_log_heatmap, eta_bins, phi_bins, 'Topo422Clusters: $Log(E_T)$ in Eta-Phi Plane', plotsDir + f'/topo_422_log_heatmap_event{eventCounter}.pdf', gfex_heatmap, jfex_heatmap, True, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi,  higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                plot_heatmap("gfex_smallr", gfex_log_heatmap, eta_bins, phi_bins, 'gFex SmallR Jets: $Log(E_T)$ in Eta-Phi Plane', plotsDir + f'/gfex_log_heatmap_event{eventCounter}.pdf', empty, empty, True, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi,  higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                if jFexPlotsBool:
                                    plot_heatmap("jfex_smallR", jfex_log_heatmap, eta_bins, phi_bins, 'jFex: $Log(E_T)$ in Eta-Phi Plane', plotsDir + f'/jfex_log_heatmap_event{eventCounter}.pdf', empty, empty, True, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi,  higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                plot_heatmap("truthjet", truthInTimeJets_log_heatmap, eta_bins, phi_bins, 'InTimeAntiKt4TruthJets: $Log(E_T)$ in Eta-Phi Plane', plotsDir + f'/truth_jets_log_heatmap_event{eventCounter}.pdf', empty, empty, True, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi,  higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                plot_heatmap("hltjet", hltJets_log_heatmap, eta_bins, phi_bins, 'HLT_AntiKt4EMTopoJets_subjesIS: $Log(E_T)$ in Eta-Phi Plane', plotsDir + f'/hlt_jets_log_heatmap_event{eventCounter}.pdf', empty, empty, True, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi,  higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                                plot_heatmap("gfex_larger", gfex_largerJets_log_heatmap, eta_bins, phi_bins, 'L1_gFexLRJetRoI: $E_T$ in Eta-Phi Plane', plotsDir + f'/gfex_larger_log_jets_heatmap_event{eventCounter}.pdf', empty, empty, False, vbf_quark_1_pt, vbf_quark_2_pt, vbf_quark_1_eta, vbf_quark_2_eta, vbf_quark_1_phi, vbf_quark_2_phi,  higgs_1_pt, higgs_2_pt, higgs_1_eta, higgs_2_eta, higgs_1_phi, higgs_2_phi, True, b1_list, b2_list, dR_1, dR_2)
                        else: 
                            if iEvt < 50:
                                empty = []
                                #plot_heatmap(topo_heatmap, eta_bins, phi_bins, 'TopoClusters: $E_T$ in Eta-Phi Plane', plotsDir + f'/topo_heatmap_event{eventCounter}.pdf')
                                plot_heatmap("topo422", topo_422_heatmap, eta_bins, phi_bins, 'Topo422Clusters: $E_T$ in Eta-Phi Plane', plotsDir + f'/topo_422_heatmap_event{eventCounter}.pdf', gfex_heatmap, jfex_heatmap)
                                plot_heatmap("topo422", topo_422_highest128_heatmap, eta_bins, phi_bins, 'Topo422Clusters: $E_T$ in Eta-Phi Plane', plotsDir + f'/topo_422_highest128_heatmap_event{eventCounter}.pdf', gfex_heatmap, jfex_heatmap)
                                plot_heatmap("gfex_smallr", gfex_heatmap, eta_bins, phi_bins, 'gFex SmallR Jets: $E_T$ in Eta-Phi Plane', plotsDir + f'/gfex_heatmap_event{eventCounter}.pdf', empty, empty)
                                if jFexPlotsBool:
                                    plot_heatmap("jfex_smallR", jfex_heatmap, eta_bins, phi_bins, 'jFex: $E_T$ in Eta-Phi Plane', plotsDir + f'/jfex_heatmap_event{eventCounter}.pdf', empty, empty)
                                #plot_heatmap(topo_log_heatmap, eta_bins, phi_bins, 'TopoClusters: $Log(E_T)$ in Eta-Phi Plane', plotsDir + f'/topo_log_heatmap_event{eventCounter}.pdf', True)
                                plot_heatmap("topo422", topo_422_log_heatmap, eta_bins, phi_bins, 'Topo422Clusters: $Log(E_T)$ in Eta-Phi Plane', plotsDir + f'/topo_422_log_heatmap_event{eventCounter}.pdf', gfex_heatmap, jfex_heatmap, True)
                                plot_heatmap("gfex_smallr", gfex_log_heatmap, eta_bins, phi_bins, 'gFex SmallR Jets: $Log(E_T)$ in Eta-Phi Plane', plotsDir + f'/gfex_log_heatmap_event{eventCounter}.pdf', empty, empty, True) # FIXME add two leading jets pt here
                                if jFexPlotsBool:
                                    plot_heatmap("jfex_smallR", jfex_log_heatmap, eta_bins, phi_bins, 'jFex: $Log(E_T)$ in Eta-Phi Plane', plotsDir + f'/jfex_log_heatmap_event{eventCounter}.pdf', empty, empty, True)
                                plot_heatmap("truthjet", truthInTimeJets_heatmap, eta_bins, phi_bins, 'InTimeAntiKt4TruthJets: $E_T$ in Eta-Phi Plane', plotsDir + f'/truth_jets_heatmap_event{eventCounter}.pdf', empty, empty)
                                plot_heatmap("hltjet", hltJets_heatmap, eta_bins, phi_bins, 'HLT_AntiKt4EMTopoJets_subjesIS: $E_T$ in Eta-Phi Plane', plotsDir + f'/hlt_jets_heatmap_event{eventCounter}.pdf', empty, empty, False)
                                plot_heatmap("truthjet", truthInTimeJets_log_heatmap, eta_bins, phi_bins, 'InTimeAntiKt4TruthJets: $Log(E_T)$ in Eta-Phi Plane', plotsDir + f'/truth_jets_log_heatmap_event{eventCounter}.pdf', empty, empty, True)
                                plot_heatmap("hltjet", hltJets_log_heatmap, eta_bins, phi_bins, 'HLT_AntiKt4EMTopoJets_subjesIS: $Log(E_T)$ in Eta-Phi Plane', plotsDir + f'/hlt_jets_log_heatmap_event{eventCounter}.pdf', empty, empty, True)
...
if signalBool:
    ...
    if higgsPtCut:
        plt.hist(higgs_pt_values_after_cut, bins=50, range=(0, 500), histtype='step', label='Higgs pT (after cut)')
        plt.xlabel(r"$p_T$ [GeV]")
        plt.ylabel('# Higgs')
